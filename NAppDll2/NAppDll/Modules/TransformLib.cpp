// TransformLib.cpp : implementation file
#include "stdafx.h"
...
BEGIN_MESSAGE_MAP(CTransformLib, CStatic)
	//{{AFX_MSG_MAP(CTransformLib)
...
// return 1 : Success
//       <0 : Failure
long CTransformLib::HoughCircle(unsigned char *fm, long left, long top, long right, long bottom, 
...
// angle : 회전각도 지정 
void CTransformLib::ImageRotation(unsigned char *SourImage, unsigned char *DestImage, long x1, long y1, long x2, long y2, float angle, long nWidth, long nHeight)
{
	long  i, j, x, y, data;
...
void CTransformLib::ImageZoom(unsigned char *SourImage, unsigned char *DestImage, long x1, long y1, long x2, long y2, float zoom_x, float zoom_y, long nWidth, long nHeight)
{
...
void CTransformLib::ImageRectToPolarOpen(long nPosX, long nPosY, float dStartAngle, float dEndAngle, float dInRadius, float dOutRadius, float dIntervalAngle,
...
void CTransformLib::ImageRectToPolar(LPBYTE pSourImage, long nOrgWidth, long nOrgHeight, LPBYTE pDestImage, long nPolWidth, long nPolHeight)
{
    long  i, j, k, nEnd;
...
void CTransformLib::ImageRectToPolarClose()
{
}

BOOL CTransformLib::TransTiltToRightRect(LPBYTE pSourImage, LPBYTE pDestImage, POINT2 ptPos1, POINT2 ptPos2, POINT2 ptPos3, POINT2 ptPos4, long nWidth, long nHeight) 
{
	long  i, j, nValue;
	...
	for(i=0; i<nLocalHeight; i++) 
	{
		...
		for(j=0; j<nLocalWidth; j++) 
		{
			...
			pDestImage[i*nLocalWidth + j] = (unsigned char)nValue;
		}
	}
