...
#define ROW_MAX_NUM           100
#define COL_MAX_NUM           100
...
{
	WCHAR     m_sTitleX[100];        // X Title String                
	WCHAR     m_sTitleY[100];        // Y Title String 
	...
	long   	  m_nSlideNumX;          // Plot의 X Slide갯수 
	long      m_nSlideNumY;          // Plot의 Y Slide갯수 
	long 	  m_nPixelDistGrid;      // X Pixel갯수 -> 한개의 Grid
	long      m_nRowHeight;
	long      m_nFontSize;
	long      m_ColWidth[COL_MAX_NUM];
