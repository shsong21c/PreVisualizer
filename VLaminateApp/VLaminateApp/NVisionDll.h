...
extern "C" _declspec(dllexport) BOOL    NVisionDll_OpenProc(LPBYTE pSourImage, LPBYTE pDestImage, long x1, long y1, long x2, long y2, long nWidth, long nHeight, long nIter);
...
extern "C" _declspec(dllexport) BOOL    NVisionDll_CloseProc(LPBYTE pSourImage, LPBYTE pDestImage, long x1, long y1, long x2, long y2, long nWidth, long nHeight, long nIter);
extern "C" _declspec(dllexport) BOOL    NVisionDll_ErodeProc(LPBYTE pSourImage, LPBYTE pDestImage, long x1, long y1, long x2, long y2, long nWidth, long nHeight, long nIter);
extern "C" _declspec(dllexport) BOOL    NVisionDll_DilateProc(LPBYTE pSourImage, LPBYTE pDestImage, long x1, long y1, long x2, long y2, long nWidth, long nHeight, long nIter);
...
extern "C" _declspec(dllexport) BOOL    NVisionDll_SetWarping(long nCamID, LPBYTE pImage, long x1, long y1, long x2, long y2, long nWidth, long nHeight, long nRow, long nCol, float dGridSize);
